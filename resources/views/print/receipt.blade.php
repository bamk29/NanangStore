...
<body>
    <div class="receipt-container">
        <div class="header">
            <p class="store-name">GILING BAKSO ANTO RAMA</p>
            <p>Dusun III Sidodadi Binjai Baru</p>
            <p>Telp: 082167996595</p>
        </div>
        ...
        <div class="footer">
            @if($transaction->customer && $transaction->customer->debt > 0)
            <p style="font-style: italic; margin-bottom: 2px; font-size: 8px;">"Menunda membayar utang bagi yang mampu adalah kezaliman. HR:Muslim"</p>
            @endif
            <p>-- Terima Kasih --</p>
        </div>
    </div>
