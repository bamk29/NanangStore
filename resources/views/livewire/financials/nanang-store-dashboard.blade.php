<div class="p-4 sm:p-6 lg:p-8">
    ...
    <div x-data="{ show: $wire.entangle('showBalanceModal') }" x-show="show" x-cloak class="fixed z-40 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
