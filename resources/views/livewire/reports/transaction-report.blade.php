        ...
        <div class="mt-6 p-4 bg-white rounded-lg shadow">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div>
                    ...
                    <select wire:model.live="selectedProductId" id="product" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div class="mt-8 space-y-6">
            ...
            @empty
                <div class="text-center py-12 bg-white rounded-lg shadow">
                    <p class="text-gray-500">Tidak ada transaksi yang cocok dengan filter yang dipilih.</p>
                </div>
            @endforelse
        </div>
    </div>
