    ...
    <div class="p-4 sm:p-6 lg:p-8">
        ...
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                <h1 class="text-2xl font-bold text-gray-900">Laporan Penjualan Nanang Store</h1>
                <p class="mt-2 text-sm text-gray-700">Analisis penjualan dan keuntungan untuk semua produk selain kategori Bakso.</p>
            </div>
        </div>
