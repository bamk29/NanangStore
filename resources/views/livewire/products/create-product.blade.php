<div class="p-4 sm:p-6 lg:p-8">
    ...
    <form wire:submit="save" class="space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="mt-1 flex rounded-md shadow-sm">
                        <input type="text" id="code" wire:model="code" class="block w-full rounded-l-md border-gray-300">
                        <button type="button" wire:click="generateCode" class="inline-flex items-center px-3 rounded-r-md border border-l-0 border-gray-300 bg-gray-50 text-gray-500 text-sm">Buat Kode</button>
                    </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div>
                    <label for="stock" class="block text-sm font-medium text-gray-700">Stok Awal (Satuan Dasar)</label>
                    <input type="number" id="stock" wire:model="stock" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                </div>
                <div>
                    <label for="box_stock" class="block text-sm font-medium text-gray-700">Stok Awal Boks</label>
        ...
        <div class="flex justify-end pt-4">
            <button type="submit" class="inline-flex items-center justify-center rounded-md border border-transparent bg-blue-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-blue-700">Simpan Produk</button>
        </div>
    </form>
</div>
